...
YUI(EXPONENT.YUI3_CONFIG).use('node','yui2-treeview','yui2-menu','yui2-animation','yui2-dragdrop','yui2-json','yui2-container','yui2-connection', function(Y) {
var YAHOO = Y.YUI2;    
...
YAHOO.util.Event.onDOMReady(DDSend.init);
